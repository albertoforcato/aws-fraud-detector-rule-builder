...
func TestRuleBuilder_AddRegexMatch(t *testing.T) {
	...
	assert.Equal(t, "regex_match(\".*\", $email)", s.String())
}
...
func TestRuleBuilder_Div(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Div(10).String()
...
func TestRuleBuilder_Equal(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Equal(10).String()
	assert.Equal(t, "$a == 10", s)
}
...
func TestRuleBuilder_GreaterThan(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).GreaterThan(10).String()
	assert.Equal(t, "$a > 10", s)
}
...
func TestRuleBuilder_GreaterThanOrEqual(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).GreaterThanOrEqual(10).String()
	assert.Equal(t, "$a >= 10", s)
}
...
func TestRuleBuilder_In(t *testing.T) {
	...
	s := rb.Var("email", VariableTypeEmail).In("a", "b", "c").String()
...
func TestRuleBuilder_LessThan(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).LessThan(10).String()
	assert.Equal(t, "$a < 10", s)
}
...
func TestRuleBuilder_LessThanOrEqual(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).LessThanOrEqual(10).String()
	assert.Equal(t, "$a <= 10", s)
}
...
func TestRuleBuilder_Mul(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Mul(10).String()
	assert.Equal(t, "$a * 10", s)
}
...
func TestRuleBuilder_NotEqual(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).NotEqual(10).String()
	assert.Equal(t, "$a != 10", s)
}
...
func TestRuleBuilder_Or(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).GreaterThan(10).Or().Var("b", VariableTypeNumeric).LessThan(20).String()
...
func TestRuleBuilder_Sub(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Sub(10).String()
	assert.Equal(t, "$a - 10", s)
}
...
func TestRuleBuilder_Not(t *testing.T) {
	...
	s := rb.Var("email", VariableTypeEmail).Not().In("a", "b", "c").String()
	assert.Equal(t, "$email not in [\"a\", \"b\", \"c\"]", s)
}
...
func TestRuleBuilder_OpenParenthesisAndCloseParenthesis(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).GreaterThan(10).And().OpenParenthesis().Var("b", VariableTypeNumeric).LessThan(20).CloseParenthesis().String()
	assert.Equal(t, "$a > 10 and ($b < 20)", s)
}
...
func TestRuleBuilder_Erase(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).GreaterThan(10).Erase().Var("b", VariableTypeNumeric).LessThan(20).String()
...
func TestRuleBuilder_Sum(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Sum(10).String()
	assert.Equal(t, "$a + 10", s)
}
...
func TestRuleBuilder_Mod(t *testing.T) {
	...
	s := rb.Var("a", VariableTypeNumeric).Mod(10).String()
	assert.Equal(t, "$a % 10", s)
}
...
func TestRuleBuilder_VarUppercase(t *testing.T) {
	...
	s := rb.VarUppercase("a", VariableTypeNumeric).GreaterThan(10).String()
...
func TestRuleBuilder_VarLowercase(t *testing.T) {
	...
	s := rb.VarLowercase("a", VariableTypeNumeric).GreaterThan(10).String()
